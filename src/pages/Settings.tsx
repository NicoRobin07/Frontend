      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <Card className="p-4 cursor-pointer hover:border-primary/50 transition-colors group" onClick={() => navigate('/settings/api-keys')}>
            ...
            <div className="space-y-2">
              <div className="p-2 bg-muted/50 rounded-lg"><p className="text-xs font-medium text-foreground">Production Key</p><p className="text-[10px] text-muted-foreground font-mono mt-0.5">****-****-****-****</p></div>
              <div className="p-2 bg-muted/50 rounded-lg"><p className="text-xs font-medium text-foreground">Test Key</p><p className="text-[10px] text-muted-foreground font-mono mt-0.5">****-****-****-****</p></div>
            </div>
